...
input_dir = '/home/ti/Downloads/insightface/src/data/out_data_crop'
pairs_filepath = '/home/ti/Downloads/insightface/src/align/out_data_crop.lst'
ret = []
label = 0
person_names = []
...
for person_name in person_names:
  ...
  for _subdir2 in os.listdir(_subdir):
    ...
    for img in os.listdir(_subdir2):
      ...
      #f.write(str(1) + '\t' + str(fimage.image_path) + '\t' + fimage.classname + '\n')
      _ret.append(fimage)
        # print(fimage)
    ret += _ret
    print(label)
